...
{       
        ...
        public :
            ...
            Transaction(pair<long long int,long long int> SenderKey , pair<long long int,long long int> RecieverKey , int Amount, long long int Sign )
            {
               ...
               string TxString=to_string(this->PublicKeyOfSenderWallet.first)+to_string(this->PublicKeyOfRecieverWallet.first)+to_string(this->AmountSent)+to_string(this->Signature)+to_string(this->TransactionNonce); 
